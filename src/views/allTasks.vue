            ...
            >
              <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                  ...
                  <th
                    scope="col"
                    class="px-2 py-3 text-right text-xs font-medium text-gray-500 uppercase"
                  >
                    Action
                  </th>
                </tr>
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                <tr v-for="(value, index) in userStore.tasks" :key="index">
                  <td class="py-3 pl-4">
                    <div class="flex items-center h-5">
                      <input
                        :id="index"
                        ...
                        class="border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                      />
                      <label :for="'N' + index" class="sr-only"></label>
                    </div>
                  </td>
                  <td
...
function filter() {
  userStore.filterTask(value);
}

function deleteTask(task) {
  userStore.removeTask(task.id);
}
</script>
